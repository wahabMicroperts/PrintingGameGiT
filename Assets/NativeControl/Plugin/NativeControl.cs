...
public class NativeControl
{
    ...
    public void SaveCSVFileToGallery(string File,string fileType, System.Action<string> _callbackImagePath)
    {
        
        string pathofimage = Androidjavaclass.CallStatic<string>("saveImageToGallery", File);
